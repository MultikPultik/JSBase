    ...
    */
    ...
    render() {
        if (this.catalogProducts.length > 0) {
            ...
            this.basketDescr.insertAdjacentHTML('beforeend', `<br><br>В корзине ${this.catalogProducts.length} товар(а,-ов) стоимостью ${this.getSumPrice()} руб.`);
        } else {
            this.basketDescr.innerHTML = '';
     ...
     */
    getSumPrice() {
        return this.catalogProducts.reduce(function (productPrice, product) {
